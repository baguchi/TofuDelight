...
public class SoyChickenModel extends Model {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LavaChicken = partdefinition.addOrReplaceChild("LavaChicken", CubeListBuilder.create().texOffs(0, 2).addBox(-4.0F, -7.0F, -5.0F, 8.0F, 7.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
		...
		PartDefinition lava_leg_r = LavaChicken.addOrReplaceChild("lava_leg_r", CubeListBuilder.create().texOffs(0, 22).addBox(-2.0F, -1.0F, -1.0F, 2.0F, 4.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(8, 19).addBox(-2.0F, -1.0F, 2.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(-4.0F, -7.0F, 3.0F));
		...
		PartDefinition lava_leg_l = LavaChicken.addOrReplaceChild("lava_leg_l", CubeListBuilder.create().texOffs(0, 22).addBox(0.0F, -1.0F, -1.0F, 2.0F, 4.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(8, 19).addBox(0.0F, -1.0F, 2.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(4.0F, -7.0F, 3.0F));
